    ...
    <div className="block mt-10 h-full w-full font-poppins">
      ...
      <div className="flex flex-col">
        ...
        <div className="w-full h-screen flex flex-row px-2 ">
          ...
          <p className="text-2xl text-[#888692]  px-8 w-4/5">Get the most out of your online classes with our real-time session summaries. Our powerful summarization tools help you efficiently recap and highlight key points covered during lectures, ensuring you never miss important information.</p>
          </div>
        </div>
      </div>
      {/* Info div ends */}
      ...
      <div className="flex flex-col">
        ...
        <div className="w-full h-screen flex flex-row px-2">
          ...
          <p className="text-2xl  text-[#888692]  px-8 w-4/5">Elevate your students' learning experience with our live quiz generation feature. Test their knowledge in real-time and reinforce lecture material with quizzes generated from lecture summaries. Engage and motivate your students with interactive learning today!</p>
      ...
      <div className="flex flex-col">
        ...
        <div className="w-full h-screen flex flex-row px-2">
          ...
          <p className="text-2xl text-[#888692] px-8 w-4/5">Get real-time feedback on student performance with automated quizzes generated from learning sessions. Effortlessly test student knowledge with MCQs and receive instant quiz responses to evaluate student progress and adjust teaching methods accordingly.</p>
          </div>
        </div>
      </div>
      {/* Info div ends */}
      ...
      <div className="flex flex-col">
        ...
        <div className="w-full h-screen flex flex-row px-2">
          ...
          <p className="text-2xl text-[#888692]  px-8 w-4/5">Our facial expression detection technology monitors student attentiveness in real-time, allowing teachers to adjust their approach to enhance learning outcomes. By analyzing facial cues, we promote focus and facilitate effective teaching for each student.</p>
          </div>
